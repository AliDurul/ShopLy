...
import { Truck, RotateCcw, Lock, Gift, Headphones } from "lucide-react";
        ...
        <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-3 text-muted-foreground">
              <Link href="https://facebook.com" aria-label="Facebook" className="hover:text-primary"><FaFacebook className="size-5" /></Link>
              <Link href="https://instagram.com" aria-label="Instagram" className="hover:text-primary"><FaInstagram className="size-5" /></Link>
              <Link href="https://twitter.com" aria-label="Twitter" className="hover:text-primary"><FaTwitter className="size-5" /></Link>
              <Link href="https://youtube.com" aria-label="YouTube" className="hover:text-primary"><FaYoutube className="size-5" /></Link>
            </div>
          </div>
        </div>
      </section>
